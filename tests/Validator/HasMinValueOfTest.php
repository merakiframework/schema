...
use Meraki\Schema\Validator\HasMinValueOf;
use PHPUnit\Framework\Attributes\Group;
use PHPUnit\Framework\Attributes\CoversClass;

#[Group('validation')]
#[CoversClass(HasMinValueOf::class)]
final class HasMinValueOfTest extends ValidatorTestCase
{
	public function createValidator(): Validator
	{
		return new HasMinValueOf(5);
	}
