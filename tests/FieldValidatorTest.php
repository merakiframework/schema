...
use Meraki\Schema\FieldValidator;
...
use Meraki\Schema\FieldType\EmailAddress as EmailAddressFieldType;
...
final class FieldValidatorTest extends TestCase
{
	...
	public function it_throws_when_resolving_validators_with_circular_dependencies(): void
	{
		...
		$this->expectExceptionObject(new CircularDependenciesFound($aValidator, [$aValidator::class, $bValidator::class, $aValidator::class]));
	...
	public function it_throws_when_resolving_validators_that_are_self_dependent(): void
	{
		...
		$this->expectExceptionObject(new CircularDependenciesFound($selfDependentValidator, [SelfDependentValidator::class, SelfDependentValidator::class]));
