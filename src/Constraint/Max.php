...
final class Max implements Constraint
{
	...
	public function validate(mixed $value): ValidationResult
	{
		if (is_string($value) && mb_strlen($value) > $this->value) {
			return ValidationResult::fail('Expected value to be at most '.$this->value.' characters long.');
		}

		if ((is_int($value) || is_float($value)) && $value > $this->value) {
			return ValidationResult::fail('Expected value to be less than or equal to '.$this->value.'.');
		}
